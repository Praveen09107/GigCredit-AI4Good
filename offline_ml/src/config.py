...
SCORING_TFLITE_CONTRACT_PATH = DATA_DIR / "scoring_tflite_contract.json"
SCORING_TFLITE_EXPORT_REPORT_PATH = DATA_DIR / "scoring_tflite_export_report.json"
SCORING_TFLITE_PARITY_REPORT_PATH = DATA_DIR / "scoring_tflite_parity_report.json"
